...
--
-- Host: localhost
-- Generation Time: Aug 08, 2022 at 03:48 PM
...
CREATE TABLE `posts` (
  ...
  `active_post` varchar(255) NOT NULL
...
INSERT INTO `posts` (`id`, `user_id`, `title`, `body`, `created_date`, `active_post`) VALUES
(1, 1, 'sunt aut facere repellat provident occaecati excepturi optio reprehenderit', 'quia et suscipit\nsuscipit recusandae consequuntur expedita et cum\nreprehenderit molestiae ut ut quas totam\nnostrum rerum est autem sunt rem eveniet architecto', '2022-08-05 16:38:01', 'true'),
...
(1, 'Leanne Graham', 'Sincere@april.biz', 'true'),
(2, 'Ervin Howell', 'Shanna@melissa.tv', 'true'),
(3, 'Clementine Bauch', 'Nathan@yesenia.net', 'false');
...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `post_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
